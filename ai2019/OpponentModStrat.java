 ...
 * 
 */
public class OpponentModStrat extends OMStrategy {
	...
	public BidDetails getBid(List<BidDetails> allBids) {
		...
		for (BidDetails bid : allBids) {
			//maximize the product of the utility of the opponent bid and the users bid 
			double evaluation = model.getBidEvaluation(bid.getBid())*(bid.getMyUndiscountedUtil());
	...
	public String getName() {
		return "maximum bid utility product";
	}
}
